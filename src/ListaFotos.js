  ...
  return (
    <>
      ...
      <section className={`${misEstilosUI.anchura} ${misEstilosUI.formulario}`}>
        ...
        {/* nuestra constante setCategoria lo enviamos a nuestro componentnte
                                                              formulario para traer el dato del input al componente padre*/}
      </section>

      <section className={`${misEstilosUI.anchura} ${misEstilosUI.seccion}`}>
        <Fotos key={categoria} category={categoria} />
        {/* A la key le asignamos un nombre la cual le asignamos en el componente Formulario */
